...
function Complaints() {
  ...
  const registerComplaint = async (e) => {
    ...
    const res = await fetch("https://hostellerhomesbackend.onrender.com/api/complaint/register", {
      method: "POST",
      headers: {
  ...
  useEffect(()=> {
    ...
    const fetchComplaints = async () => {
      const res = await fetch("https://hostellerhomesbackend.onrender.com/api/complaint/student", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
