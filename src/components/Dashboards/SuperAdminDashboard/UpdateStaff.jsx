...
// //     console.log(`${mainUri}/api/auth/get-all-staff-details`);
...
// //   }
// //     try {
// //       const res = await fetch(`${mainUri}/api/auth/get-all-staff-details`, {
// //         method: "GET",
...
// //     try {
// //       const res = await fetch(`${mainUri}/api/auth/delete-staff/${id}`, {
// //         method: "DELETE",
// //       });
// //       const data = await res.json();
...
// //     e.preventDefault();
// //     try {
// //       const res = await fetch(`${mainUri}/update-staff/${selectedStaff._id}`, {
// //         method: "PUT",
// //         headers: { "Content-Type": "application/json" },
...
// //   if (loading) return <p className="text-center text-lg">Loading staff details...</p>;
...
// //           <p className="text-gray-600">{member.role || "Unknown Role"}</p>
...
//     try {
//       const res = await fetch(`${mainUri}/api/auth/update-staff/${selectedStaff._id}`, {
//         method: "PUT",
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: `Bearer ${token}`,
...
//   // ✅ UI
//   if (loading) return <p className="text-center text-lg pt-24">Loading staff details...</p>;
...
//         <h1 className="text-3xl font-bold text-gray-800 mt-4 text-center">All Staff Members</h1>
...
//             >
//               <h2 className="text-lg font-semibold text-gray-900">{member.name || "No Name"}</h2>
...
//               <h2 className="text-xl font-semibold mb-4 text-center">Update Staff</h2>
//               <form onSubmit={handleUpdateSubmit}>
//                 <label className="block mb-2 font-medium">Name:</label>
//                 <input
//                   type="text"
