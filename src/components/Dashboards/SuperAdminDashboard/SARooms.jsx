...
//         `${mainUri}/api/rooms/all?hostelNo=${hostelNo}`
//       );
...
//           <select name="hostelNo" id="hostelNo" className="p-2"
//             onChange={(e)=>
//             {
//                 setHostelNo(e.target.value);
//                 fetchRooms();
//             }
//             }
//             value={hostelNo}
...
export default function SARooms() {
  ...
  // ✅ Fetch rooms whenever hostelNo changes
  useEffect(() => {
    if (hostelNo) fetchRooms();
  }, [hostelNo]);
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-center mb-6">
          ...
          >
            ...
            <option value="1" selected>Hostel 1</option>
            <option value="2">Hostel 2</option>
            <option value="3">Hostel 3</option>
            <option value="4">Hostel 4</option>
            <option value="5">Hostel 5</option>
