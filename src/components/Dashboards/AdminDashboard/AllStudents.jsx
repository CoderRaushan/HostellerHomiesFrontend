...
function AllStudents() {
  const getCSV = async () => {
    ...
    const res = await fetch("https://hostellerhomesbackend.onrender.com/api/student/csv", {
      method: "POST",
      headers: {
  ...
  const deleteStudent = async (id) => {
    const res = await fetch("https://hostellerhomesbackend.onrender.com/api/student/delete-student", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
