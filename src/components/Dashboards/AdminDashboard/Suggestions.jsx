...
function Suggestions() {
  const getSuggestions = async () => {
    ...
    const response = await fetch("https://hostellerhomesbackend.onrender.com/api/suggestion/hostel", {
      method: "POST",
      headers: {
  ...
  const updateSuggestion = async (id) => {
    setLoader(true);
    const response = await fetch("https://hostellerhomesbackend.onrender.com/api/suggestion/update", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
