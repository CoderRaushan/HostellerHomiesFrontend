...
function Home() {
  ...
  const getComplaints = async () => {
    ...
    const response = await fetch(`https://hostellerhomesbackend.onrender.com/api/complaint/hostel`, {
      method: "POST",
      headers: {
  ...
  const getSuggestions = async () => {
    ...
    const response = await fetch(
      "https://hostellerhomesbackend.onrender.com/api/suggestion/hostel",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const getRequests = async () => {
    const hostel = JSON.parse(localStorage.getItem("hostel"));
    const res = await fetch("https://hostellerhomesbackend.onrender.com/api/messoff/list", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  return (
    <div className="ml-48 h-screen flex flex-col gap-3 items-center justify-center max-h-screen overflow-x-hidden overflow-y-auto pt-[400px] sm:pt-96 md:pt-96 lg:pt-80 xl:pt-20">
