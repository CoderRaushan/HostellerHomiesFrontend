            ...
            <div className="bg-indigo-600 md:w-1/3 p-8 text-white">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-80">123 Business Ave, Suite 100<br />New York, NY 10001</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12">
                <div className="flex space-x-4">
                  <a href="#" className="bg-indigo-500 p-2 rounded-full hover:bg-indigo-400 transition-colors">
