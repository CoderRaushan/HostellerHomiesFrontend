...
export default function AdminSignIn() {
  ...
  const getHostel = async () => {
    ...
    try {
      const res = await fetch("https://hostellerhomesbackend.onrender.com/api/admin/get-hostel", {
        method: "POST",
        headers: {
  ...
  let login = async (event) => {
    ...
    if (result.success) {
      ...
      let admin = await fetch("https://hostellerhomesbackend.onrender.com/api/admin/get-admin", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
